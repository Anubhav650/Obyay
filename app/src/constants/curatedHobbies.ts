...
export const CURATED_HOBBIES: Hobby[] = [
  {
    ...
    category: "music",
    summary:
      "A beginner-friendly roadmap to get comfortable with the guitar, master open chords, and strum your first songs.",
    ...
    techniques: [
      {
        ...
        description:
          "Understand string numbering (1-6), fret positions, and how to read basic guitar tab coordinates.",
        whyItMatters:
          "It is the baseline coordinate system for playing any chord or melody.",
        order: 1,
        ...
        quiz: {
          question:
            "Which string is the thinnest and highest-pitched string on a standard guitar?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Standard guitar strings are numbered 1 through 6, starting from the thinnest, highest-pitched string (1st string, High E) to the thickest, lowest-pitched string (6th string, Low E).",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Learn the finger placements for G Major, C Major, and D Major chords in the open position near the headstock.",
        whyItMatters:
          "These three chords form the foundation of thousands of famous popular songs.",
        order: 2,
        ...
        quiz: {
          question:
            "Which of these chords requires placing fingers on the 1st, 2nd, and 6th strings in the 3rd fret?",
          options: ["D Major", "C Major", "G Major", "A Minor"],
          correctIndex: 2,
          explanation:
            "G Major is standardly played by placing fingers on the 6th string (3rd fret), 5th string (2nd fret), and thinnest 1st/2nd strings (3rd fret).",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Practice the standard down-up strumming rhythm (Down, Down-Up, Up-Down-Up) in 4/4 timing.",
        whyItMatters:
          "Keeping steady time is more important for making music than playing perfect notes.",
        order: 3,
        ...
        quiz: {
          question:
            "What is the most critical rule when practicing strumming rhythms?",
          options: [
          ...
          correctIndex: 2,
          explanation:
            "Keeping a continuous, relaxed up-and-down motion with your hand acts as a natural metronome, even if you do not strike the strings on every pass.",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Practice placing one finger per fret sequentially down a single string (frets 1-2-3-4) then switching strings.",
        whyItMatters:
          "Builds essential left-hand finger strength, calluses, and coordination.",
        order: 4,
        ...
        quiz: {
          question:
            'What is the primary benefit of the "Spider Walk" finger exercise?',
          options: [
          ...
          correctIndex: 1,
          explanation:
            "The Spider Walk isolates each finger, forcing you to stretch and press notes cleanly, building dexterity and individual muscle memory.",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Practice transitioning slowly between G, C, and D chords, focusing on moving all fingers simultaneously.",
        whyItMatters:
          "Allows you to play songs fluidly without awkward pauses between chord changes.",
        order: 5,
        ...
        quiz: {
          ...
          correctIndex: 0,
          explanation:
            "An anchor finger is a finger common to both chords that does not need to lift during the transition, providing a pivot point for faster changes.",
        },
        flashcards: [
          {
  ...
  },
  {
    ...
    category: "strategy",
    summary:
      "Master opening principles, develop minor pieces, castle early, and learn fundamental tactical forks and pins.",
    createdAt: new Date().toISOString(),
    techniques: [
      {
        id: "cc-1",
        name: "Center Control",
        description:
          "Move pawns to e4/d4 (or e5/d5 as black) to occupy and influence the central squares in the opening.",
        whyItMatters:
          "Controlling the center gives your pieces freedom of movement while cramping your opponent.",
        order: 1,
        ...
        quiz: {
          question:
            "Why is controlling the center (e4, d4, e5, d5) so important in the opening?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Centrally placed pieces act like hubs; knights control 8 squares, and bishops/queens sweep across both diagonals.",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Develop knights and bishops early to active squares where they can coordinate and prepare for castling.",
        whyItMatters:
          "Knights and bishops are your primary skirmishers; leaving them home is like fighting with one arm.",
        order: 2,
        ...
        quiz: {
          question:
            "Which minor piece is generally developed first in classic king-pawn openings?",
          options: [
            "The Queen",
          ...
          correctIndex: 1,
          explanation:
            "Developing the knight to f3 (for white) attacks the center, coordinates safety, and clears the path to castle early.",
        },
        flashcards: [
          {
            front: "Minor Pieces",
      ...
      },
      {
        ...
        name: "King Castling",
        description:
          "Perform the castling move (move king two squares toward rook, rook jumps over) to secure your king.",
        whyItMatters:
          "An uncastled king in the center is highly vulnerable to devastating checks and pins.",
        order: 3,
        ...
        quiz: {
          ...
          correctIndex: 2,
          explanation:
            "You cannot castle if the king is currently in check, if the king passes through check, or if there are pieces in between.",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        name: "Tactical Forks",
        description:
          "Identify opportunities to attack two of your opponent's pieces simultaneously with a single piece.",
        whyItMatters:
          "Forks force your opponent to defend one piece while you capture the other, winning material.",
        order: 4,
        ...
        quiz: {
          question:
            "Which piece is famously known for its ability to deliver devastating forks due to its L-shaped movement?",
          options: ["The Bishop", "The Knight", "The Rook", "The Pawn"],
          correctIndex: 1,
          explanation:
            "Knights are the ultimate forking pieces because they can hop over blockages and attack multiple pieces without being easily blocked.",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        whyItMatters:
          "Restricts your opponent's piece movements and allows you to pile up attackers on the pinned target.",
        order: 5,
        ...
        quiz: {
          ...
          correctIndex: 1,
          explanation:
            "Absolute pins involve the King; moving the pinned piece would expose the King to check, which is illegal. Relative pins involve other pieces (like the Queen).",
        },
        flashcards: [
          {
      ...
      },
      {
        ...
        description:
          "Learn the technique to push an opponent's lone king to the edge of the board using your king and queen.",
        whyItMatters:
          "It is the most common winning endgame scenario; failing to mate results in a draw (stalemate).",
        order: 6,
        ...
        quiz: {
          question:
            "What major trap must you avoid when delivering King and Queen mate against a lone King?",
          options: [
            "Losing your king",
          ...
          correctIndex: 1,
          explanation:
            "Stalemate is a draw. When boxing the king in, always make sure the opponent's king has at least one escape square unless you are delivering direct check.",
        },
        flashcards: [
          {
